...
/**
 * TreatmentController handles adding new treatments and listing treatments
...
public class TreatmentController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if ("list".equalsIgnoreCase(action) && apptIdParam != null) {
            try {
                ...
                req.getRequestDispatcher("/pages/Doctor/viewtreatments.jsp")
                   .forward(req, resp);
            } catch (Exception e) {
            ...
            req.getRequestDispatcher("/pages/Doctor/AddTreatment.jsp")
               .forward(req, resp);
        }
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
            throws ServletException, IOException {
        try {
            // Only doctors should add treatments; ensure session exists
            ...
            // On success, redirect to list of treatments for this appointment
