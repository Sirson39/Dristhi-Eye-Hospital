...
<head>
  ...
  <!-- Dashboard CSS -->
  <link href="${pageContext.request.contextPath}/css/Doctorcss/DoctorDashboard.css" rel="stylesheet"/>
</head>
<body>
  ...
  <div class="sidebar">
    <div class="logo-container">
      <img src="${pageContext.request.contextPath}/images/Logo2.png" alt="Drishti Logo"/>
    </div>
    <h2>Dr. John Doe</h2>
    <nav>
      <a href="${pageContext.request.contextPath}/DoctorDashboard.jsp" class="active"><i class="fas fa-home"></i> Dashboard</a>
